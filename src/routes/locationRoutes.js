...
router.get('/demand-clusters', (req, res) => LocationController.getDemandClusters(req, res));
...
router.get('/seller-reliability/:sellerId', (req, res) => LocationController.getSellerReliability(req, res));
